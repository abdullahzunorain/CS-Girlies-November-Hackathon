...
const CharacterSelect = () => {
  ...
  const handleContinue = () => {
    if (selectedCharacter) {
      // Save character selection (Person 2 will handle backend)
  ...
  return (
    <div className="character-select" style={{ backgroundImage: `url(${bg1})` }}>
      <div className="character-select-container">
          ...
          {characters.map((character) => (
            ...
            >
              ...
              <div 
                ...
                style={{ background: `linear-gradient(135deg, ${character.color} 0%, #764ba2 100%)` }}
              >
        ...
        >
          Continue {selectedCharacter ? '→' : '(Pick a character first!)'}
        </button>
